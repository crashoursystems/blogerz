...
<div class="container">
    <form action="{{route('market.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="exampleInputEmail1">Имя товара</label>
            <input type="text" name="servicename" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Название">
        </div>
